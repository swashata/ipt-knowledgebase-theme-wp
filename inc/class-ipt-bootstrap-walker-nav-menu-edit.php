<?php
if ( ! class_exists( 'IPT_Bootstrap_Walker_Nav_Menu_Edit' ) ) :
/**
 * Create HTML list of nav menu input items.
 *
 * This is a clone of Walker_Nav_Menu_Edit from the core
 *
 * It implements the two extra fields
 * 1. Divider after this item
 * 2. Icon
 * The custom values must be saved using the APIs provided later on this class
 *
 * @package iPanelThemes
 * @since 1.0.0
 * @uses Walker_Nav_Menu
 */
class IPT_Bootstrap_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	/**
...
} // IPT_Bootstrap_Walker_Nav_Menu_Edit
endif;
