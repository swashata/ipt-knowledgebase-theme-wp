	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move">
			<form id="move_reply" name="move_reply" method="post" action="<?php the_permalink(); ?>">
				...
				<div class="bbp-form">
					<h3><?php printf( __( 'Move reply "%s"', 'bbpress' ), bbp_get_reply_title() ); ?></h3>
					...
					<h4><?php _e( 'Move Method', 'bbpress' ); ?></h4>
					...
					<div class="bbp-submit-wrapper">
						<button class="btn btn-lg btn-primary" type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit" name="bbp_move_reply_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
					</div>
