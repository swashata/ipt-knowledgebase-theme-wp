				...
				<div>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_reply_edit() ) : ?>
						...
						<div class="bbp-form">
							...
							<div class="form-group">
								<label class="sr-only" for="bbp_reply_edit_reason"><?php printf( __( 'Optional reason for editing:', 'bbpress' ), bbp_get_current_user_name() ); ?></label>
								<input placeholder="<?php printf( esc_attr__( 'Optional reason for editing:', 'bbpress' ), bbp_get_current_user_name() ); ?>" class="form-control" type="text" value="<?php bbp_form_reply_edit_reason(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_reply_edit_reason" id="bbp_reply_edit_reason" />
							</div>
						</div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="btn btn-lg btn-primary"><?php _e( 'Submit', 'bbpress' ); ?></button>
